                ...
                <div className="prose max-w-none text-gray-700 text-justify">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        {[
                            ...
                            { name: "Dr. Aakansha Rout", affiliation: "NIT, Raipur" },
                            ...
                            { name: "Dr. Ashima Sindhu Mohanty", affiliation: "GIET University, Gunupur" },
                            { name: "Dr. Ranjita Rout", affiliation: "GIET University, Gunupur" },
                            { name: "Mrs. Padmini Mishra", affiliation: "GIET University, Gunupur" },
                            { name: "Mrs. Bandana Mallick", affiliation: "GIET University, Gunupur" },
                        ].map((member, index) => (
                            <div
                                key={index}
